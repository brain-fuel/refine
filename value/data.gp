...
type DataKind enum { NumberData; TextData; BoolData; ListData; RecordData; VariantData }
...
func (d Data) Size() int { if d.node==nil{return 0};match d.Kind(){case RecordData():return len(d.node.fields);case ListData():return len(d.node.items);case VariantData():return len(d.node.items);case _:return 0} }
