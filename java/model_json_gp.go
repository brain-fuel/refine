// Code generated by goplus from model_json.gp. DO NOT EDIT.
//goplus:v v0.28.0
...
func moduleUsesJSON(module *language.Module) bool {
	for _, decl := range module.Types {
		if typeUsesJSON(decl.Body) {
			return true
		}
		for _, variant := range decl.Variants {
			for _, argument := range variant.Arguments {
				if typeUsesJSON(argument) {
					return true
				}
			}
		}
