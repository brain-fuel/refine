...
public final class NativeRegexHarness {
 ...
 public static void main(String[] args){
  ...
  var bounded=new RegexCheck(RegexCheck.Limits.defaults(),new RegexCheck.RegexLimits(16384,1<<20,100,8L<<20,50));start=System.nanoTime();resource(()->bounded.validate(attack));long elapsed=System.nanoTime()-start;if(elapsed<10_000_000L||elapsed>2_000_000_000L)throw new AssertionError("guest cancellation deadline was not observed: "+elapsed);new RegexCheck().validate(VALID);
