// Code generated by goplus from assertion_test.gp. DO NOT EDIT.
//goplus:v v0.28.0
...
func TestAnonymousFunctionAndLocalContracts(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			...
			if tc.failure != "" {
				if failure == nil || failure.code != tc.failure {
					t.Fatalf("got %v, want %s", failure, tc.failure)
				}
				return
			}
			if failure != nil {
...
func TestNamedParentSubstitutionDoesNotRerunRules(t *testing.T) {
	...
	if validation.StateName(report.State()) != "invalid" || report.Incomplete() || len(report.Diagnostics()) != 1 {
