// Code generated by goplus from trampoline_test.gp. DO NOT EDIT.
//goplus:v v0.28.0
...
`
	...
	if e.depth != 0 {
		t.Fatalf("logical helper depth leaked: %d", e.depth)
	}
}
...
func TestEvaluatorRecursiveLoopFailsByBudgetNotHostDepth(t *testing.T) {
	...
	if failure == nil || failure.code != "evaluation.budget" {
		t.Fatalf("failure = %v, want evaluation.budget", failure)
	}
}
