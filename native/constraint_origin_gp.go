// Code generated by goplus from constraint_origin.gp. DO NOT EDIT.
//goplus:v v0.28.0
...
func (p *Project) constraintOrigin(resource string) nativeConstraintOrigin {
	...
	if origin := p.nativeOrigins[resource]; origin != nil {
		return origin
	}
	...
	if origin := p.jsonOrigins[resource]; origin != nil {
		return origin
	}
	return nil
}
