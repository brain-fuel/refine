// Code generated by goplus from source_composition.gp. DO NOT EDIT.
//goplus:v v0.28.0
...
func appendNativeSourceDeclarations(source, addition string) (string, error) {
	...
	base, _, present, err := language.SplitReleasePolicyFooter(source)
	if err != nil {
		return "", err
	}
	footer := ""
	if present {
		footer = source[len(base):]
	}
	if len(source) > 16<<20 || len(addition) > (16<<20)-len(source)-3 {
		return "", fmt.Errorf("native source composition exceeds the 16 MiB language source limit")
	}
